...
export default function Header() {
  return (
    ...
    <div  className={cx('flex items-center')}>
      <HeaderItem icon={<BsTelephoneFill/>} content="Bán hàng" type="link" />
      <HeaderItem icon={<AiOutlineCheckCircle/>} content="Bảo hành" type=""/>
      <HeaderItem icon={<BsCartDash/>} content="Giỏ hàng" type=""/>
    </div>
    </div>
  )
}
